...
const vendor: VendorConfig = {
  ...
  inputs: [
    ...
    { key: "baseUrl", label: "请求地址", type: "url", required: false, placeholder: "默认 https://api.anthropic.com，可填中转代理地址" },
  ],
  inputValues: {
    apiKey: "",
    baseUrl: "",
  ...
  models: [
    ...
    { name: "Claude Haiku 4.5", modelName: "claude-haiku-4-5-20251001", type: "text", think: true },
  ],
};
// ============================================================
// 适配器函数
